...
# Menyimpan model
with open('/content/drive/MyDrive/Colab Notebooks/BelajarPenerapanDataScience/Submission 2/model.pkl', 'wb') as model_file:
    pickle.dump(model, model_file)

"""##### Upload data"""

# Menimpan data yang sudah diolah
df.to_csv('/content/drive/MyDrive/Colab Notebooks/BelajarPenerapanDataScience/Submission 2/data_submission_2.csv', index=False)

# Membaca data yang sudah diolah
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/BelajarPenerapanDataScience/Submission 2/data_submission_2.csv')
df